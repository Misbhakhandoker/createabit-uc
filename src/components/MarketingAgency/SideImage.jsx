...
function SideImage() {
  ...
  return (
    <section className="sideimg-numbers section-padding sub-bg">
      ...
      <div className="bg-left bg-img parallaxie d-flex align-items-center justify-content-center" data-background="/dark/assets/imgs/background/3.jpg">
        <div className="bg-white vid-circle text-dark">
          <a href="https://youtu.be/KYRWkuJVXes" className="vid" onClick={openVideo}>
            <span className="icon">
