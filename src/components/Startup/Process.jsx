...
function Process() {
  ...
  return (
    <div className="intro-feat section-padding ontop">
      <div className="container pb-0 section-padding bord-thin-top bord-dark">
            ...
            <div className="bg-img full-width d-flex align-items-center justify-content-center" data-background="/dark/assets/imgs/background/13.jpg">
              <div>
                <div className="play-button">
                  <a href="https://youtu.be/KYRWkuJVXes" className="btn vid" onClick={openVideo}>
          ...
          <div className="row">
            {
              data.map(item => (
                <div className="item col-lg-3 col-md-6" key={item.id}>
                  ...
                  <p>{item.text}</p>
                  <Link href="/dark/page-services" className="mt-20 arrow">
