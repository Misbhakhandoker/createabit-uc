    ...
    <div className="container">
      <div className="service-slider ">
        ...
        >
          ...
          <SplideSlide>
            <Link href='/dark/web-development'>
            <button
          ...
          <SplideSlide>
          <Link href='/dark/web-application'>
            <button
              className={`service-btn-clr service-butn-md butn-bord radius-30 ${
          ...
          <SplideSlide>
          <Link href='/dark/mobile-apps-development'>
            <button
              className={`service-btn-clr service-butn-md butn-bord radius-30 ${
          ...
          <SplideSlide>
          <Link href='/dark/digital-marketing-seo'>
            <button
              className={`service-btn-clr service-butn-md butn-bord radius-30 ${
          ...
          <SplideSlide>
          <Link href='/dark/video-animation'>
            <button
              className={`service-btn-clr service-butn-md butn-bord radius-30 ${
          ...
          <SplideSlide>
          <Link href='/dark/graphics-design-&-printing'>
            <button
              className={`service-btn-clr service-butn-md butn-bord radius-30 ${
